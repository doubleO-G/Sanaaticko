...
CREATE TABLE `admin_contact` (
  ...
  `lat` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `long` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `brands` (`id`, `name`, `url`, `logo_image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Brand 1', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(2, 'Brand 2', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(3, 'Brand 3', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(4, 'Brand 4', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(5, 'Brand 5', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(6, 'Brand 6', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(7, 'Brand 7', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(8, 'Brand 8', 'https://example.com', NULL, 1, '2025-01-15 16:47:50', '2025-01-15 16:47:50');
...
CREATE TABLE `general_settng` (
  ...
  `currency_sybmol` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `currency_id` bigint UNSIGNED DEFAULT NULL,
  `timezone` varchar(255) DEFAULT NULL,
  `user_verify` int DEFAULT NULL,
  ...
  `org_commission` int DEFAULT NULL,
  `push_notification` int DEFAULT NULL,
  ...
  `mail_notification` int NOT NULL,
  ...
  `enable_twillio` int DEFAULT '0',
  `vonege_api_key` varchar(150) DEFAULT NULL,
  `vonage_account_secret` varchar(150) DEFAULT NULL,
  `vonage_sender_number` varchar(150) DEFAULT NULL,
  `enable_vonage` int DEFAULT '0',
  `enable_google_signin` tinyint(1) DEFAULT '0',
  `google_client_id` varchar(255) DEFAULT NULL,
  `google_client_secret` varchar(255) DEFAULT NULL,
  `terms_services` text,
  `privacy_policy_organizer` text,
  `terms_use_organizer` text,
  `appuser_privacy_policy` text,
  ...
  `help_center` text,
  `show_event_report_form` tinyint DEFAULT '1',
  `show_link_banner` int DEFAULT '1',
  `show_brands_carousel` int DEFAULT '1',
  `googleplay_link` varchar(255) DEFAULT NULL,
...
CREATE TABLE `language` (
  ...
  `code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'en' COMMENT 'Example: en, fr, ar',
...
INSERT INTO `language` (`id`, `name`, `code`, `json_file`, `image`, `direction`, `status`, `created_at`, `updated_at`) VALUES
(1, 'English', 'en', 'English.json', 'English.png', 'ltr', 1, '2021-08-24 01:09:46', '2021-08-24 01:09:46');
...
INSERT INTO `module` (`id`, `module`, `is_enable`, `is_install`, `updated_at`, `created_at`) VALUES
(1, 'Seatmap', 0, 0, '2025-01-15 16:47:50', '2025-01-15 16:47:50'),
(2, 'BankPayout', 0, 0, '2025-01-15 16:47:50', '2025-01-15 16:47:50');
...
CREATE TABLE `organizer_payment_keys` (
  ...
  `stripe` int DEFAULT NULL,
  `paypal` int DEFAULT NULL,
  `razor` int DEFAULT NULL,
  `flutterwave` int DEFAULT NULL,
...
CREATE TABLE `payment_setting` (
  ...
  `flutterDebugMode` int DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tax` (
  ...
  `allow_all_bill` int NOT NULL DEFAULT '1',
  `status` int NOT NULL DEFAULT '1',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tickets` (
  ...
  `maximum_checkins` int DEFAULT NULL,
  `quantity` int NOT NULL,
  `ticket_per_order` int DEFAULT '1',
...
CREATE TABLE `users` (
  ...
  `provider` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'LOCAL',
  `provider_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'defaultuser.png',
...
INSERT INTO `users` (`id`, `organization_name`, `first_name`, `last_name`, `email`, `email_verified_at`, `is_verify`, `password`, `otp`, `remember_token`, `device_token`, `provider`, `provider_token`, `image`, `phone`, `bio`, `country`, `org_id`, `status`, `language`, `created_at`, `updated_at`) VALUES
(1, 'adminorg', 'admin', 'mainone', 'admin@gmail.com', NULL, 1, '$2a$12$UN2wHSQlPQIFQfM.eg8mrOS9FCu5e7yRiT.0ztil1HhNlpqF.I7ei', NULL, NULL, NULL, 'LOCAL', NULL, 'defaultuser.png', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(2, NULL, 'Barrack', 'Obama', 'obama@gmail.com', NULL, 0, '$2y$10$Io5V066WPfzVM6DIoWduXu4xoumgH52m1T0RXSQUJMDUfmijBWPJ6', NULL, NULL, NULL, 'LOCAL', NULL, 'defaultuser.png', '0799848582', NULL, NULL, NULL, 1, 'English', '2025-01-15 17:06:42', '2025-01-15 17:06:42'),
(3, NULL, 'Scania', 'skana', 'skana@gmail.com', NULL, 0, '$2y$10$kr0DkgYfwlTpnJCaw2o8juCpx9YfTdDHzj7mRAVOIeDFOdGOPSq4K', NULL, NULL, NULL, 'LOCAL', NULL, 'defaultuser.png', '9678764764', NULL, NULL, 2, 1, 'English', '2025-01-15 17:16:16', '2025-01-15 17:16:16');
...
ALTER TABLE `event_faqs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_faqs_ibfk_1` (`event_id`);
